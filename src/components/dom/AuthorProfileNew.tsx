...
export function AuthorProfileNew({ info }: { info: AuthorInfo }) {
  return (
    <div
                    ...
                    <div className="flex items-center gap-2">
                      {skill.img && (
                        <img
                          src={skill.img}
                          alt={skill.title}
                          className="w-4 h-4 opacity-40 group-hover/skill:opacity-100 grayscale group-hover/skill:grayscale-0 transition-all duration-500 object-contain"
                        />
                      )}
